...
# 컬럼명 별칭 as 별칭 : ResultSet에 표기되는 컬럼명에 별칭 (alias) 부여 가능
# ===============================================================
select
    menu_name as 메뉴명,
...
# select절에 작서오디지 않은 컬럼도 정렬 기준이 될 수 있다
select
    menu_name
from
    tbl_menu
...
# 메뉴 테이블에서 가격이 10,000원이상 , 20,000원 이하인
# 메뉴의 메뉴명, 가격, 카테고리 코드 조회
# 가격 내림차순으로 조회
select
    menu_name,
    menu_price,
