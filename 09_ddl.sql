...
/* [작성법]
    ...
    컬럼2 자료형 [default] [comment],
    컬럼3 자료형 [default] [comment],
    ...
   );
 */
...
insert into products(name) values ('텀블러');
insert into products(name,price) values ('머그컵',5000);
...
(user_no, user_id, user_pwd, user_name, gender, phone, email)
VALUES
(3, null, 'pass03', '이순신', '남', '010-888-8888', 'lee222@gmail.com');
...
(user_no, user_id, user_pwd, user_name, gender, phone, email)
VALUES
(3, 'user03', 'pass03', '이순신', '남', '010-888-8888', 'lee222@gmail.com');
...
#  Duplicate entry '3-100-2026-06-12 11:31:38' for key 'order_composite_pk.PRIMARY'
...
# - 참조는 다른 테이블의 PK 또는 UNIQUE가 설정된 컬람만 참조 가능하다
